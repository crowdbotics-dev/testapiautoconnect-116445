...
## Project Structure
    ...
    ├── testapiautoconnect_116445  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116445`
...
2. Clone this repo and `cd testapiautoconnect_116445`
